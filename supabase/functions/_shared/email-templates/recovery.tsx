...
export const RecoveryEmail = ({
  ...
  <Html lang="pt-BR" dir="ltr">
    <Head />
    <Preview>🔐 Sua nova senha está a um clique — Bibi Motos</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={content}>
          ...
          <Text style={subtitle}>
            Recebemos seu pedido para redefinir a senha. Sem preocupação, é rápido e fácil!
          </Text>
          <Text style={text}>
            Clique no botão abaixo para criar uma nova senha para sua conta na Bibi Motos:
          </Text>
